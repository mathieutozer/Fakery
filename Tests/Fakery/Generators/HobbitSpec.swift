    ...
    describe("Hobbit") {
      ...
      describe("#character") {
        it("returns the correct text") {
          let character = hobbit.character(using: &system)
      ...
      describe("#thorins_company") {
        it("returns the correct text") {
          let thorinsCompany = hobbit.thorinsCompany(using: &system)
      ...
      describe("#quote") {
        it("returns the correct text") {
          let quote = hobbit.quote(using: &system)
      ...
      describe("#location") {
        it("returns the correct text") {
          let location = hobbit.location(using: &system)
